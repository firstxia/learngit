...
public class LogUtil {
	...
	// 其他级别的日志好像不行
//	public static boolean DEBUG = Log.isLoggable(TAG, Log.VERBOSE); // 控制打印不同级别的log
//	public static boolean DEBUG = Log.isLoggable(TAG, Log.WARN);
//	public static boolean DEBUG = Log.isLoggable(TAG, Log.ERROR);
//	public static boolean DEBUG = Log.isLoggable(TAG, Log.DEBUG);
	public static boolean DEBUG = true; // 测试阶段,改为true,打印日志;上线时修改为false,屏蔽日志
